...
let g:coc_global_extensions = ['coc-tslint-plugin', 'coc-tsserver', 'coc-css', 'coc-html', 'coc-json', 'coc-prettier', 'coc-pyright', 'coc-phpls']
...
set linebreak
autocmd Filetype html,ruby,javascript,yml,yaml,json,haskell,ejs,htmldjango,nodejs setlocal ts=2 sts=2 sw=2
set noswapfile
set wildignore+=*.pyc
...
" iniciamos NERDTreeToggle cuando entremos a nvim pero con la condicion de que si es una sola ventana no se muestre
autocmd bufenter * if (winnr("$") == 1 && exists("b:NERDTree") && b:NERDTree.isTabTree()) | q | endif

" Se agrega el mapeo para iniciar el NERDTreeToggle con el ctrl + n 
